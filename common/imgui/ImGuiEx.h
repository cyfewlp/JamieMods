...
FLAGS_CLASS_BODY(ColorEditFlags)
FLAGS_CLASS_FUNCTION(ColorEditFlags, None)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoAlpha)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoPicker)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoOptions)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoSmallPreview)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoInputs)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoTooltip)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoLabel)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoSidePreview)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoDragDrop)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoBorder)
FLAGS_CLASS_FUNCTION(ColorEditFlags, NoColorMarkers)
FLAGS_CLASS_FUNCTION(ColorEditFlags, AlphaOpaque)
FLAGS_CLASS_FUNCTION(ColorEditFlags, AlphaNoBg)
FLAGS_CLASS_FUNCTION(ColorEditFlags, AlphaPreviewHalf)
FLAGS_CLASS_FUNCTION(ColorEditFlags, AlphaBar)
FLAGS_CLASS_FUNCTION(ColorEditFlags, HDR)
FLAGS_CLASS_FUNCTION(ColorEditFlags, DisplayRGB)
FLAGS_CLASS_FUNCTION(ColorEditFlags, DisplayHSV)
FLAGS_CLASS_FUNCTION(ColorEditFlags, DisplayHex)
FLAGS_CLASS_FUNCTION(ColorEditFlags, Uint8)
FLAGS_CLASS_FUNCTION(ColorEditFlags, Float)
FLAGS_CLASS_FUNCTION(ColorEditFlags, PickerHueBar)
FLAGS_CLASS_FUNCTION(ColorEditFlags, PickerHueWheel)
FLAGS_CLASS_FUNCTION(ColorEditFlags, InputRGB)
