...
[CommonLibSSE NG](https://github.com/CharmedBaryon/CommonLibSSE-NG): This is an experimental reverse engineered library for Skyrim VR (ported from CommonLibSSE). There are two main branches (VR) which is based on po3's using ifdefs, and NG which is an updated NG build.
