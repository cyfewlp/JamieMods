...
static void printPlayerInventory(RE::Actor *player)
{
...
void Transmogrify::AccessPlayerInventory()
{
...
void Transmogrify::GetAllArmors(MapToSet *modToArmors)
{
...
void Transmogrify::CombineEventSinks::Install()
{
