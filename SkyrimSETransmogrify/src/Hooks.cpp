...
template <typename T>
std::uintptr_t __install(REL::Relocation<T> hook, void *func)
{
...
void Hooks::InitWornFormHook::InitWornForm(
    RE::TESObjectARMO *a_armor, RE::TESRace *a_race, RE::BSTSmartPointer<RE::BipedAnim> *a_biped, bool isFemale
)
{
...
RE::GFxMovieDef *Hooks::GFXLoaderHook::MyCreateMovie(
    RE::GFxLoader *self, char *a_filename, RE::GFxLoader::LoadConstants a_loadConstants, std::size_t a_memoryArena
)
{
